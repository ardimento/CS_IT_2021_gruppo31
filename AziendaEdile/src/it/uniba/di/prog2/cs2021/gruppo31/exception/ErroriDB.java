...
public class ErroriDB {
	...
	public static final String DADO_ALREADY_EXISTS = "ERROR: Dado già esistente!";
	...
	public static final String IMPIEGATO_ALREADY_EXISTS = "ERROR: Impiegato già esistente!";
}