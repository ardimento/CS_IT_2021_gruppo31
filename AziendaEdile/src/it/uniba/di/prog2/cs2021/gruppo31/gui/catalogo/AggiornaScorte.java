...
public class AggiornaScorte extends JFrame {
	...
	public AggiornaScorte (HomePage home) {
		...
		JLabel lblInserisciPrezzoDado = new JLabel("Nuovo numero di pezzi:");
		lblInserisciPrezzoDado.setBounds(16, 100, 166, 15);
		...
		btnAggiungi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				} catch (NumberFormatException | AziendaException e1) {
					JOptionPane.showMessageDialog(null,"ERROR: Inserire un numero intero positivo!");
					return;
				} catch (Exception e1) {
				...
				dispose();
				new Catalogo(home);
				JOptionPane.showMessageDialog(null, "Numero di pezzi aggiornato correttamente!");
			}
		});
